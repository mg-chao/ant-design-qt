...
class AdTagSelect final : public AdAbstractSelectWidget {
  ...
  Q_PROPERTY(QVariantList selectedValues READ selectedValues WRITE setSelectedValues
                 NOTIFY selectedValuesChanged)
  Q_PROPERTY(int maxSelectionCount READ maxSelectionCount WRITE setMaxSelectionCount
                 NOTIFY maxSelectionCountChanged)
  ...
  Q_PROPERTY(QStringList tokenSeparators READ tokenSeparators WRITE setTokenSeparators
                 NOTIFY tokenSeparatorsChanged)
