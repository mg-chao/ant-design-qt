...
class AdMultiSlider : public QWidget {
  Q_OBJECT
  ...
  Q_PROPERTY(bool invertedAppearance READ invertedAppearance WRITE setInvertedAppearance
                 NOTIFY invertedAppearanceChanged)
  Q_PROPERTY(bool invertedControls READ invertedControls WRITE setInvertedControls
                 NOTIFY invertedControlsChanged)
  Q_PROPERTY(bool markSnapEnabled READ markSnapEnabled WRITE setMarkSnapEnabled
                 NOTIFY markSnapEnabledChanged)
  ...
  Q_PROPERTY(bool markStepSnapEnabled READ markStepSnapEnabled WRITE setMarkStepSnapEnabled
                 NOTIFY markStepSnapEnabledChanged)
  Q_PROPERTY(bool selectionHighlightVisible READ selectionHighlightVisible
                 WRITE setSelectionHighlightVisible NOTIFY selectionHighlightVisibleChanged)
  ...
  Q_PROPERTY(QList<double> handleValues READ handleValues WRITE setHandleValues NOTIFY handleValuesChanged)
  Q_PROPERTY(int currentHandle READ currentHandle WRITE setCurrentHandle NOTIFY currentHandleChanged)
  ...
  Q_PROPERTY(int minimumHandleCount READ minimumHandleCount WRITE setMinimumHandleCount
                 NOTIFY minimumHandleCountChanged)
  Q_PROPERTY(int maximumHandleCount READ maximumHandleCount WRITE setMaximumHandleCount
                 NOTIFY maximumHandleCountChanged)
 ...
 private:
  ...
  void setHandlesInternal(const QList<double>& handles,
