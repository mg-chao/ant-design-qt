...
class AdPopconfirm final : public QObject {
  ...
  Q_PROPERTY(adqt::widgets::AdPopupActivationMode visibilityMode READ visibilityMode WRITE setVisibilityMode
  ...
  Q_PROPERTY(QDialogButtonBox::StandardButtons autoCloseButtons READ autoCloseButtons WRITE setAutoCloseButtons
                 NOTIFY autoCloseButtonsChanged)
  Q_PROPERTY(QMessageBox::Icon icon READ icon WRITE setIcon NOTIFY iconChanged)
  Q_PROPERTY(adqt::icons::IconRef customIconRef READ customIconRef WRITE setCustomIconRef
                 NOTIFY customIconRefChanged)
