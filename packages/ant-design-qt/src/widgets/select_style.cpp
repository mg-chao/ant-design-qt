...
SelectVisualStyle resolveSelectVisualStyle(const SelectStyleInput& input,
  ...
  style.selectorBorderColor = resolveTokenColor(colorTokens.selectorBorder, style.selectorBorderColor);
  ...
  style.optionSelectedColor = resolveTokenColor(colorTokens.optionSelectedText, style.optionSelectedColor);
