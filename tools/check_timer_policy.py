...
DEFAULT_SCAN_ROOTS = (
    Path("packages/ant-design-qt/src"),
    Path("examples/theme-demo"),
)
ALLOWLIST_FILES = {
    Path("packages/ant-design-qt/src/widgets/detail/timing_hub.cpp"),
    Path("packages/ant-design-qt/src/widgets/detail/timing_hub.h"),
}
PATTERNS = (
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Check timer usage policy for ant-design-qt.")
    parser.add_argument(
        "--scan-root",
        action="append",
        default=[],
