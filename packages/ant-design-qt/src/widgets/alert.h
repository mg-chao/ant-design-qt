...
class AdAlert final : public QFrame {
  ...
  Q_PROPERTY(QWidget* leadingWidget READ leadingWidget WRITE setLeadingWidget NOTIFY leadingWidgetChanged)
  Q_PROPERTY(QWidget* textWidget READ textWidget WRITE setTextWidget NOTIFY textWidgetChanged)
  Q_PROPERTY(QWidget* informativeWidget READ informativeWidget WRITE setInformativeWidget
                 NOTIFY informativeWidgetChanged)
  Q_PROPERTY(QWidget* actionsWidget READ actionsWidget WRITE setActionsWidget NOTIFY actionsWidgetChanged)
