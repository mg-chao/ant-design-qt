...
class AdNavigationMenuPopupFactory : public QObject {
 ...
 public:
  ...
  virtual QWidget* createPopup(const AdNavigationMenuPopupContext& context,
...
class AdNavigationMenu final : public QWidget, private detail::InWindowPopupOwner {
  Q_OBJECT
  ...
  Q_PROPERTY(TriggerSubMenuAction submenuTrigger READ submenuTrigger WRITE setSubmenuTrigger NOTIFY submenuTriggerChanged)
  ...
  Q_PROPERTY(adqt::widgets::AdNavigationMenuPopupFactory* popupFactory READ popupFactory WRITE setPopupFactory
                 NOTIFY popupFactoryChanged)
 ...
 private:
  ...
  detail::MenuVisualStyle resolvedVisualStyle(Mode mode, ColorScheme colorScheme, bool collapsed) const;
