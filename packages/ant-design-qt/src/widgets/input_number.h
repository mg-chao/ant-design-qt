...
class AdInputNumberTextPolicy : public QObject {
 ...
 public:
  ...
  virtual QString formatText(const QString& canonicalText,
                             bool editing,
...
class AdInputNumber final : public QAbstractSpinBox {
  ...
  Q_PROPERTY(bool stepButtonsVisible READ stepButtonsVisible WRITE setStepButtonsVisible
                 NOTIFY stepButtonsVisibleChanged)
  Q_PROPERTY(bool stepKeysEnabled READ stepKeysEnabled WRITE setStepKeysEnabled
                 NOTIFY stepKeysEnabledChanged)
  Q_PROPERTY(bool wheelStepEnabled READ wheelStepEnabled WRITE setWheelStepEnabled
                 NOTIFY wheelStepEnabledChanged)
  ...
  Q_PROPERTY(QString exactMinimum READ exactMinimum WRITE setExactMinimum NOTIFY exactMinimumChanged)
  Q_PROPERTY(QString exactMaximum READ exactMaximum WRITE setExactMaximum NOTIFY exactMaximumChanged)
  Q_PROPERTY(QString exactSingleStep READ exactSingleStep WRITE setExactSingleStep NOTIFY exactSingleStepChanged)
 ...
 private:
  ...
  StyleContext buildStyleContext(bool interactiveButtons, const QVariant& visualValue) const;
  ...
  void setCommittedValueInternal(const QVariant& value,
                                 bool emitSignal,
                                 bool preserveEditorText,
                                 bool clampToRange);
  void emitCommittedValueSignals(const QVariant& previousValue, bool previousHasValue);
  QString displayTextForValue(const QVariant& value, bool userTyping, const QString& input) const;
