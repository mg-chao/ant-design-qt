...
class AdSwitch final : public QAbstractButton {
  ...
  Q_PROPERTY(adqt::icons::IconRef checkedIconRef READ checkedIconRef WRITE setCheckedIconRef NOTIFY checkedIconRefChanged)
  Q_PROPERTY(adqt::icons::IconRef uncheckedIconRef READ uncheckedIconRef WRITE setUncheckedIconRef NOTIFY uncheckedIconRefChanged)
