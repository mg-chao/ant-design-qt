...
QWidget* PopconfirmDocsPage::makePopconfirm(const QString& triggerText,
                                            const QString& title,
                                            const QString& description,
                                            Triggers triggers,
                                            QWidget* parent,
                                            AdPopconfirm** popconfirmOut) {
...
QWidget* PopconfirmDocsPage::buildBasicDemo() {
  ...
  QWidget* trigger =
      makePopconfirm("Delete", "Delete the task", "Are you sure to delete this task?", Trigger::Click, nullptr,
                     &popconfirm);
...
QWidget* PopconfirmDocsPage::buildPlacementDemo() {
  ...
  auto addPlacement = [&](int row, int column, const QString& text, Placement placement) {
    AdPopconfirm* popconfirm = nullptr;
    QWidget* trigger = makePopconfirm(text, title, description, Trigger::Click, nullptr, &popconfirm);
...
QWidget* PopconfirmDocsPage::buildAutoShiftDemo() {
  ...
  AdPopconfirm* popconfirm = nullptr;
  QWidget* trigger = makePopconfirm("Scroll The Window",
...
QWidget* PopconfirmDocsPage::buildDynamicTriggerDemo() {
  ...
  QWidget* triggerWidget =
      makePopconfirm("Delete a task", "Delete the task", "Are you sure to delete this task?", Trigger::Click, nullptr,
                     &popconfirm);
...
QWidget* PopconfirmDocsPage::buildIconDemo() {
  ...
  QWidget* customIconTrigger =
      makePopconfirm("Custom icon", "Delete the task", "Are you sure to delete this task?", Trigger::Click, nullptr,
                     &customIcon);
  adqt::icons::IconColorOverrides iconColors;
  iconColors.primary = QColor("#ff4d4f");
  iconColors.hasPrimary = true;
  customIcon->setCustomIconRef(outlined_icons::QuestionCircle(iconColors));
...
QWidget* PopconfirmDocsPage::buildPromiseDemo() {
  ...
  AdPopconfirm* popconfirm = nullptr;
  QWidget* trigger = makePopconfirm("Open Popconfirm with Promise",
                                    "Title",
  ...
  connect(popconfirm, &AdPopconfirm::visibilityRequested, this, [popconfirm, status](bool nextOpen) {
...
QWidget* PopconfirmDocsPage::buildStyleClassDemo() {
  ...
  QWidget* objectStyleTrigger =
      makePopconfirm("Object Style", "Object text", "Object description", Trigger::Click, nullptr, &objectStyle);
  ...
  QWidget* functionStyleTrigger =
      makePopconfirm("Function Style", "Function text", "Function description", Trigger::Click, nullptr,
                     &functionStyle);
...
QWidget* PopconfirmDocsPage::buildRenderPanelDemo() {
  ...
  QWidget* panelATrigger =
      makePopconfirm("Panel A", "Are you OK?", "Does this look good?", Trigger::Click, nullptr, &panelA);
  panelA->setVisible(true);

  AdPopconfirm* panelB = nullptr;
  QWidget* panelBTrigger =
      makePopconfirm("Panel B", "Are you OK?", "Does this look good?", Trigger::Click, nullptr, &panelB);
  panelB->setPlacement(Placement::BottomRight);
  panelB->setVisible(true);

  AdPopconfirm* panelC = nullptr;
  QWidget* panelCTrigger = makePopconfirm("Panel C", "Are you OK?", QString(), Trigger::Click, nullptr, &panelC);
  panelC->setIcon(Icon::NoIcon);
  panelC->setVisible(true);

  AdPopconfirm* panelD = nullptr;
  QWidget* panelDTrigger =
      makePopconfirm("Panel D", "Are you OK?", "Does this look good?", Trigger::Click, nullptr, &panelD);
...
QWidget* PopconfirmDocsPage::buildWireframeDemo() {
  ...
  AdPopconfirm* panelA = nullptr;
  QWidget* panelATrigger =
      makePopconfirm("Wireframe A", "Are you OK?", "Wireframe-like semantic style.", Trigger::Click, nullptr,
                     &panelA);
  demo::bindThemeRefresh(panelATrigger, [panelA, panelATrigger]() {
    ...
    wireframeStyles.container.backgroundColor = demo::themeColorOr(map.colorBgElevated, QColor("#ffffff"));
    ...
    wireframeStyles.description.textColor = demo::themeColorOr(map.colorTextSecondary, QColor("#595959"));
    wireframeStyles.arrow.backgroundColor = demo::themeColorOr(map.colorBgElevated, QColor("#ffffff"));
  ...
  AdPopconfirm* panelB = nullptr;
  QWidget* panelBTrigger =
      makePopconfirm("Wireframe B", "Are you OK?", "Bottom-right wireframe style.", Trigger::Click, nullptr,
                     &panelB);
