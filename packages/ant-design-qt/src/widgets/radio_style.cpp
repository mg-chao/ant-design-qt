...
RadioMetrics baseMetrics(AdRadio::ControlSize controlSize,
...
RadioVisualStyle resolveRadioVisualStyle(const RadioStyleInput& input,
  ...
  const QColor colorTextDisabled = toColor(map.colorTextDisabled, QColor(QStringLiteral("#bfbfbf")));
  ...
  style.checkedDisabled = {colorBorder, colorBgContainerDisabled, dotColorDisabled, colorTextDisabled};
