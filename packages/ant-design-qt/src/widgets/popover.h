...
class AdPopover final : public QObject, private detail::OverlayPopupControllerDelegate {
  ...
  Q_PROPERTY(adqt::widgets::AdPopupActivationMode visibilityPolicy READ visibilityPolicy WRITE setVisibilityPolicy
                 NOTIFY visibilityPolicyChanged)
  ...
  Q_PROPERTY(bool defaultVisible READ defaultVisible WRITE setDefaultVisible NOTIFY defaultVisibleChanged)
  ...
  Q_PROPERTY(QWidget* sourceWidget READ sourceWidget WRITE setSourceWidget NOTIFY sourceWidgetChanged)
  ...
  Q_PROPERTY(int titleMinimumWidth READ titleMinimumWidth WRITE setTitleMinimumWidth NOTIFY titleMinimumWidthChanged)
