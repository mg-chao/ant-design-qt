...
QPalette buildPalette(const AdTheme& theme, const QPalette& basePalette) {
  ...
  const QColor bgLayout = roleColor(semantic.window, palette.color(QPalette::Active, QPalette::Window));
  const QColor bgContainer = roleColor(semantic.surface, palette.color(QPalette::Active, QPalette::Base));
  ...
  const QColor textDisabled = roleColor(semantic.textDisabled, palette.color(QPalette::Disabled, QPalette::Text));
  const QColor textPlaceholder =
      roleColor(semantic.textPlaceholder, palette.color(QPalette::Active, QPalette::PlaceholderText));
  ...
  const QColor primary =
      roleColor(semantic.accent, roleColor(semantic.accentSolid, palette.color(QPalette::Active, QPalette::Highlight)));
  const QColor primaryDisabled = roleColor(semantic.accentDisabled, roleColor(semantic.textDisabled, primary));
