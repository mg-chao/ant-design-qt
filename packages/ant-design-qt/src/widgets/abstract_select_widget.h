...
class AdAbstractSelectWidget : public QWidget {
  ...
  Q_PROPERTY(adqt::widgets::select::SearchPolicy searchPolicy READ searchPolicy WRITE setSearchPolicy
                 NOTIFY searchPolicyChanged)
  Q_PROPERTY(adqt::widgets::select::Placement placement READ placement WRITE setPlacement
                 NOTIFY placementChanged)
  Q_PROPERTY(adqt::widgets::select::PopupWidthMode popupWidthMode READ popupWidthMode
                 WRITE setPopupWidthMode NOTIFY popupWidthModeChanged)
  ...
  Q_PROPERTY(adqt::widgets::select::Variant variant READ variant WRITE setVariant
