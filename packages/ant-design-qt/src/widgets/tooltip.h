...
class AdTooltip final : public QObject {
  ...
  Q_PROPERTY(adqt::widgets::AdPopupPlacement placement READ placement WRITE setPlacement NOTIFY placementChanged)
  Q_PROPERTY(adqt::widgets::AdPopupTriggers triggers READ triggers WRITE setTriggers NOTIFY triggersChanged)
  Q_PROPERTY(bool visible READ isVisible WRITE setVisible NOTIFY visibleChanged)
  Q_PROPERTY(adqt::widgets::AdPopupActivationMode activationMode READ activationMode WRITE setActivationMode
                 NOTIFY activationModeChanged)
  ...
  Q_PROPERTY(bool initiallyVisible READ initiallyVisible WRITE setInitiallyVisible NOTIFY initiallyVisibleChanged)
  ...
  Q_PROPERTY(int hoverOpenDelayMs READ hoverOpenDelayMs WRITE setHoverOpenDelayMs NOTIFY hoverOpenDelayMsChanged)
  Q_PROPERTY(int hoverCloseDelayMs READ hoverCloseDelayMs WRITE setHoverCloseDelayMs NOTIFY hoverCloseDelayMsChanged)
  Q_PROPERTY(bool enabled READ isEnabled WRITE setEnabled NOTIFY enabledChanged)
  Q_PROPERTY(QString text READ text WRITE setText NOTIFY textChanged)
  Q_PROPERTY(QWidget* targetWidget READ targetWidget WRITE setTargetWidget NOTIFY targetWidgetChanged)
  ...
  Q_PROPERTY(QRect triggerRect READ triggerRect WRITE setTriggerRect RESET clearTriggerRect NOTIFY triggerRectChanged)
  Q_PROPERTY(bool hasAnchorRect READ hasAnchorRect NOTIFY anchorRectChanged)
  Q_PROPERTY(QRect anchorRect READ anchorRect WRITE setAnchorRect RESET clearAnchorRect NOTIFY anchorRectChanged)
