...
class AdImageViewer final : public QObject {
  ...
  Q_PROPERTY(QString countTextFormat READ countTextFormat WRITE setCountTextFormat
                 NOTIFY countTextFormatChanged)
  ...
  Q_PROPERTY(adqt::widgets::AdImageLoader* imageLoader READ imageLoader WRITE setImageLoader
                 NOTIFY imageLoaderChanged)
 ...
 signals:
  ...
  void currentItemChanged(int currentRow,
                          int totalCount,
 ...
 private:
  ...
  void handlePreviewCurrentItemChanged(int currentRow,
                                       int totalCount,
                                       const adqt::widgets::AdImageItem& item,
                                       const QSize& actualSize);
...
class AdImage final : public QWidget {
  ...
  Q_PROPERTY(QUrl fallbackSource READ fallbackSource WRITE setFallbackSource NOTIFY fallbackSourceChanged)
  Q_PROPERTY(QUrl placeholderSource READ placeholderSource WRITE setPlaceholderSource
                 NOTIFY placeholderSourceChanged)
  Q_PROPERTY(QUrl previewSource READ previewSource WRITE setPreviewSource NOTIFY previewSourceChanged)
  Q_PROPERTY(adqt::widgets::AdImageItems previewItems READ previewItems WRITE setPreviewItems
                 NOTIFY previewItemsChanged)
  Q_PROPERTY(bool previewEnabled READ previewEnabled WRITE setPreviewEnabled NOTIFY previewEnabledChanged)
  Q_PROPERTY(QString previewText READ previewText WRITE setPreviewText NOTIFY previewTextChanged)
  Q_PROPERTY(QSize preferredImageSize READ preferredImageSize WRITE setPreferredImageSize
                 NOTIFY preferredImageSizeChanged)
