...
class AdRadioButtonGroup final : public QButtonGroup {
  ...
  Q_PROPERTY(adqt::widgets::AdRadio::Variant variant READ variant WRITE setVariant NOTIFY variantChanged)
  Q_PROPERTY(adqt::widgets::AdRadio::ButtonStyle buttonStyle READ buttonStyle WRITE setButtonStyle
                 NOTIFY buttonStyleChanged)
  Q_PROPERTY(Distribution distribution READ distribution WRITE setDistribution NOTIFY distributionChanged)
