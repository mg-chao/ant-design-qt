...
class ColorPickerValueModel {
 public:
  ...
  static State stateFromSelection(const AdColorSelection& selection,
                                  ...
                                  Mode preferredMode,
                                  int activeStopIndex = 0);
  static State stateFromCssValue(const QString& cssValue,
                                 const QVector<Mode>& modeOptions,
                                 Mode preferredMode,
                                 int activeStopIndex = 0,
                                 bool* ok = nullptr);
  ...
  static QString formattedValue(const AdColorSelection& selection, Format format, int activeStopIndex = 0);
