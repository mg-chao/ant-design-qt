...
AdMultiSelect::AdMultiSelect(QWidget* parent) : AdAbstractSelectWidget(parent) {
  ...
  connect(internalSelect(), &AdSelect::currentValuesChanged, this, &AdMultiSelect::selectedValuesChanged);
  connect(internalSelect(), &AdSelect::currentItemsChanged, this, &AdMultiSelect::selectedItemsChanged);
  connect(internalSelect(), &AdSelect::selectionChanged, this, &AdMultiSelect::selectionChanged);
  connect(internalSelect(), &AdSelect::maxCountChanged, this, &AdMultiSelect::maxSelectionCountChanged);
  connect(internalSelect(), &AdSelect::maxTagCountChanged, this, &AdMultiSelect::maxVisibleTagsChanged);
