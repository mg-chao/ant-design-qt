...
class AdTextEdit final : public QTextEdit {
  ...
  Q_PROPERTY(AdLineEdit::ControlSize controlSize READ controlSize WRITE setControlSize
  ...
  Q_PROPERTY(int minimumVisibleRows READ minimumVisibleRows WRITE setMinimumVisibleRows
                 NOTIFY minimumVisibleRowsChanged)
  Q_PROPERTY(int maximumVisibleRows READ maximumVisibleRows WRITE setMaximumVisibleRows
                 NOTIFY maximumVisibleRowsChanged)
  Q_PROPERTY(adqt::widgets::AdInputTextPolicy* textPolicy READ textPolicy WRITE setTextPolicy
