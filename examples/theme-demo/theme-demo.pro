...
INCLUDEPATH += ../../packages/adqt-icon-core/src
...
isEmpty(ADQT_ICON_CORE_LIB_BUILD_DIR) {
    ADQT_ICON_CORE_LIB_BUILD_DIR = $$clean_path($$OUT_PWD/../../packages/adqt-icon-core)
}
!exists($$ADQT_ICON_CORE_LIB_BUILD_DIR) {
    ADQT_ICON_CORE_LIB_BUILD_DIR = $$clean_path($$PWD/../../packages/adqt-icon-core/build-mingw)
}
