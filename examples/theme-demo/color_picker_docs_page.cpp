...
QColor triggerTextColor(const QColor& color) {
  ...
  return luminance >= 160 ? QColor(QStringLiteral("#262626"))
  ...
  void paintEvent(QPaintEvent* event) override {
    ...
    for (int y = 0; y < height(); y += kCheckerCellSize) {
      for (int x = 0; x < width(); x += kCheckerCellSize) {
        ...
        painter.fillRect(QRect(x, y, kCheckerCellSize, kCheckerCellSize),
                         lightCell ? QColor(QStringLiteral("#ffffff"))
    ...
    if (color_.alpha() == 0) {
      painter.setPen(QPen(QColor(QStringLiteral("#ff4d4f")), 2.0, Qt::SolidLine, Qt::RoundCap,
                          Qt::RoundJoin));
...
ColorPickerDocsPage::ColorValue ColorPickerDocsPage::gradient(const QVector<GradientStop>& stops) {
  ...
  const QColor editableColor =
      gradientStops.isEmpty() ? QColor(QStringLiteral("#1677ff")) : gradientStops.constFirst().second;
...
QWidget* ColorPickerDocsPage::buildControlledDemo() {
  ...
  connect(onChangePicker, &AdColorPicker::cssTextChanged, this,
          [liveLabel](const QString& css) {
            liveLabel->setText(QStringLiteral("cssTextChanged: %1").arg(css));
          });
  connect(onCompletePicker, &AdColorPicker::editingFinished, this, [completeLabel, onCompletePicker](const ColorValue&) {
    completeLabel->setText(QStringLiteral("editingFinished: %1").arg(onCompletePicker->cssText()));
  });
...
QWidget* ColorPickerDocsPage::buildLineGradientDemo() {
  ...
  const ColorValue defaultGradient = gradient(
      {GradientStop{parseCssColor(QStringLiteral("rgb(16, 142, 233)"), QColor()), 0},
  ...
  connect(mixed, &AdColorPicker::editingFinished, this,
          [output, mixed](const ColorValue&) {
...
QWidget* ColorPickerDocsPage::buildAllowClearDemo() {
  ...
  connect(picker, &AdColorPicker::editingFinished, this,
          [output, picker](const ColorValue&) { output->setText(QStringLiteral("value: %1").arg(picker->cssText())); });
...
QWidget* ColorPickerDocsPage::buildPresetsDemo() {
  ...
  primary.colors = {
      solid(QStringLiteral("#e6f4ff")),
      solid(QStringLiteral("#bae0ff")),
      solid(QStringLiteral("#91caff")),
      solid(QStringLiteral("#69b1ff")),
      solid(QStringLiteral("#4096ff")),
      solid(QStringLiteral("#1677ff")),
      solid(QStringLiteral("#0958d9")),
      solid(QStringLiteral("#003eb3")),
      solid(QStringLiteral("#002c8c")),
      solid(QStringLiteral("#001d66")),
  };
  ...
  red.key = red.label;
  red.colors = {
      solid(QStringLiteral("#fff1f0")),
      solid(QStringLiteral("#ffccc7")),
      solid(QStringLiteral("#ffa39e")),
      solid(QStringLiteral("#ff7875")),
      solid(QStringLiteral("#ff4d4f")),
      solid(QStringLiteral("#f5222d")),
      solid(QStringLiteral("#cf1322")),
      solid(QStringLiteral("#a8071a")),
      solid(QStringLiteral("#820014")),
      solid(QStringLiteral("#5c0011")),
  };
  ...
  green.colors = {
      solid(QStringLiteral("#f6ffed")),
      solid(QStringLiteral("#d9f7be")),
      solid(QStringLiteral("#b7eb8f")),
      solid(QStringLiteral("#95de64")),
      solid(QStringLiteral("#73d13d")),
      solid(QStringLiteral("#52c41a")),
      solid(QStringLiteral("#389e0d")),
      solid(QStringLiteral("#237804")),
      solid(QStringLiteral("#135200")),
      solid(QStringLiteral("#092b00")),
  };
