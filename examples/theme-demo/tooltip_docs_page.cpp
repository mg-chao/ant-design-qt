...
QWidget* TooltipDocsPage::makeTooltip(const QString& triggerText,
                                      const QString& title,
                                      Triggers triggers,
                                      QWidget* parent,
                                      AdTooltip** tooltipOut) {
...
QWidget* TooltipDocsPage::buildShiftDemo() {
  ...
  AdTooltip* tooltip = nullptr;
  QWidget* trigger =
      makeTooltip("Near top-left", "Thanks for using antd. Have a nice day !", Trigger::Click, frame, &tooltip);
...
QWidget* TooltipDocsPage::buildAutoAdjustOverflowDemo() {
  ...
  AdTooltip* tooltip = nullptr;
  QWidget* trigger = makeTooltip("Placement: left", "Prompt Text", Trigger::Click, nullptr, &tooltip);
...
QWidget* TooltipDocsPage::buildDestroyOnHiddenDemo() {
  ...
  AdTooltip* tooltip = nullptr;
  QWidget* trigger =
      makeTooltip("Dom will destroyed when Tooltip close", "prompt text", Trigger::Hover, nullptr, &tooltip);
...
QWidget* TooltipDocsPage::buildColorfulDemo() {
  ...
  for (int i = 0; i < presetColors.size(); ++i) {
    AdTooltip* tooltip = nullptr;
    QWidget* trigger = makeTooltip(presetColors.at(i), "prompt text", Trigger::Hover, nullptr, &tooltip);
...
QWidget* TooltipDocsPage::buildStyleClassDemo() {
  ...
  QWidget* objectStyled = makeTooltip("Object Style", "Object text", Trigger::Click, nullptr,
                                      &objectStyledTooltip);
