...
class AdModal final : public QObject {
  ...
  Q_PROPERTY(bool closeOnMaskClick READ closeOnMaskClick WRITE setCloseOnMaskClick
                 NOTIFY closeOnMaskClickChanged)
  ...
  Q_PROPERTY(bool acceptButtonBusy READ acceptButtonBusy WRITE setAcceptButtonBusy
                 NOTIFY acceptButtonBusyChanged)
  Q_PROPERTY(bool contentLoading READ contentLoading WRITE setContentLoading NOTIFY contentLoadingChanged)
  ...
  Q_PROPERTY(adqt::widgets::AdButton::AccentRole acceptAccentRole READ acceptAccentRole
                 WRITE setAcceptAccentRole NOTIFY acceptAccentRoleChanged)
  Q_PROPERTY(adqt::widgets::AdButton::ButtonStyle acceptButtonStyle READ acceptButtonStyle
                 WRITE setAcceptButtonStyle NOTIFY acceptButtonStyleChanged)
  ...
  Q_PROPERTY(QWidget* footerWidget READ footerWidget WRITE setFooterWidget NOTIFY footerWidgetChanged)
...
class AdModalService final {
 ...
 private:
  static AdModal* showStaticRequest(const Request& request, AdModal::Preset defaultPreset, QWidget* ownerWindow);
};
