...
PopoverDocsPage::PopoverDocsPage(QWidget* parent) : QWidget(parent) {
  ...
  auto* subtitle = new QLabel(
      "A floating card that appears on hover, focus, click or context menu, aligned to a source widget.");
  ...
  addSection(root, "Controlled Open", "External state drives popup visibility.", buildControlledDemo());
  addSection(root, "Hover With Click", "Mixed nested interaction pattern.", buildHoverWithClickDemo());
  addSection(root, "Visual Styling", "Direct Qt-style color and font properties.", buildVisualStyleDemo());
  addSection(root, "Visual Properties", "Override layout, geometry and surface metrics.", buildVisualPropertyDemo());
...
QWidget* PopoverDocsPage::makePopover(const QString& triggerText,
                                      const QString& title,
...
QWidget* PopoverDocsPage::buildArrowDemo() {
  ...
  AdPopover* popover = nullptr;
  QWidget* trigger =
      makePopover("Arrow demo", "Arrow", "Toggle arrow visibility and center alignment.", Trigger::Click, nullptr,
                  &popover);
  popover->setVisible(true);
...
QWidget* PopoverDocsPage::buildAutoShiftDemo() {
  ...
  AdPopover* popover = nullptr;
  QWidget* trigger = makePopover("Near top-left", "Auto Adjust", "Try resizing window: popover keeps visible area.",
                                 Trigger::Click, frame, &popover);
  ...
  layout->addWidget(makeHintLabel("This mirrors antd auto-shift behavior on narrow or edge viewport."));
  return box;
}
...
QWidget* PopoverDocsPage::buildHoverWithClickDemo() {
  ...
  QWidget* outerTrigger = makePopover("Hover area", "Hover title", "Hover content", Trigger::Hover, nullptr, &outer);
  ...
  QWidget* innerTrigger =
      makePopover("Click inside", "Click title", "Nested click popover content", Trigger::Click, clickInsideHost);
...
QWidget* PopoverDocsPage::buildVisualStyleDemo() {
  ...
  QWidget* fixedTrigger =
      makePopover("Fixed style", "Visual", "Direct colors and fonts from Qt properties.", Trigger::Click, nullptr,
                  &fixed);
...
QWidget* PopoverDocsPage::buildApiOverview() {
  ...
  const QVector<QPair<QString, QString>> rows = {
      ...
      {"titleFont/textFont/backgroundColor/borderColor", "Qt-style visual customization properties"},
      {"contentMargins/titleMinimumWidth/maximumWidth/cornerRadius", "layout and geometry customization"},
