...
class AdTag final : public QAbstractButton {
  ...
  Q_PROPERTY(bool autoHideOnClose READ autoHideOnClose WRITE setAutoHideOnClose
                 NOTIFY autoHideOnCloseChanged)
  Q_PROPERTY(adqt::icons::IconRef iconRef READ iconRef WRITE setIconRef NOTIFY iconRefChanged)
  Q_PROPERTY(adqt::icons::IconRef closeIconRef READ closeIconRef WRITE setCloseIconRef
                 NOTIFY closeIconRefChanged)
 ...
 public:
  ...
  using ComponentTokenResolver =
      std::function<ComponentTokens(const ComponentTokenContext&)>;
