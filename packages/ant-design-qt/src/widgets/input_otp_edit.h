...
class AdOtpEdit final : public QWidget {
  ...
  Q_PROPERTY(adqt::widgets::AdOtpCodeFormatter* codeFormatter READ codeFormatter
                 WRITE setCodeFormatter NOTIFY codeFormatterChanged)
  Q_PROPERTY(adqt::widgets::AdOtpSeparatorFactory* separatorFactory READ separatorFactory
                 WRITE setSeparatorFactory NOTIFY separatorFactoryChanged)
