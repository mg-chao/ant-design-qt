...
class ThemeManager final : public QObject {
 ...
 public:
  ...
  ResolvedTheme resolve(const QWidget* widget = nullptr, const QWidget* logicalOwner = nullptr) const;
  ThemeMapToken resolveTheme(const QWidget* widget = nullptr, const QWidget* logicalOwner = nullptr) const;
