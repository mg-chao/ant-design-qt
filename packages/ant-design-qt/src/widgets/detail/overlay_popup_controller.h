...
class OverlayPopupControllerDelegate {
 public:
  ...
  virtual void popupApplyResolvedPlacement(OverlayPopupPlacement placement, qreal arrowCenterCoord) = 0;
  virtual bool popupReleaseOnHide() const { return false; }
  virtual void popupReleaseSurface() {}
};

class OverlayPopupController final : public QObject, private InWindowPopupOwner {
  Q_OBJECT
 ...
 public:
  ...
  explicit OverlayPopupController(OverlayPopupControllerDelegate* delegate, QObject* parent = nullptr);
